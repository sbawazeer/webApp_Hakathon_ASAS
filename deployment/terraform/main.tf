...
####### RDSDB MySQL
resource "alicloud_rdsdb_cluster" "cluster" {
  db_type       = "MySQL"
  db_version    = "5.6"
...
resource "alicloud_rdsdb_account" "account" {
  db_cluster_id       = alicloud_rdsdb_cluster.cluster.id
  account_name        = "test_rdsdb" ## Please change accordingly
  account_password    = "N1cetest"     ## Please change accordingly
...
resource "alicloud_rdsdb_account_privilege" "privilege" {
  db_cluster_id     = alicloud_rdsdb_cluster.cluster.id
  account_name      = alicloud_rdsdb_account.account.account_name
